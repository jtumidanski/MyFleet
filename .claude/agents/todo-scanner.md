...
name: todo-scanner
description: |
  Use this agent to scan the entire MyFleet codebase for TODO/FIXME/XXX/HACK markers and unimplemented stubs, categorize by service, prioritize, and update docs/TODO.md. Heavy file-scanning work isolated from the main agent's context window.
...
```markdown
# MyFleet Project TODO

This document tracks planned features and improvements for the MyFleet project.
