...
MyFleet UI uses **Jest 30** with **React Testing Library** and **jsdom** environment. Tests live alongside source files in `__tests__/` directories or as `*.test.{ts,tsx}` files.
