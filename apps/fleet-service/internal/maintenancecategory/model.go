...
// Model is the immutable maintenance category domain model. A nil FleetID
// means a system/global category visible to every fleet; a non-nil value
// scopes the row to one fleet (design §8.2, §10.1).
type Model struct {
	id            string
	name          string
	description   string
