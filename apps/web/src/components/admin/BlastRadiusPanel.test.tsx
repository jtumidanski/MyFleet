...
describe('BlastRadiusPanel', () => {
  it('lists what a purge would delete, per domain', () => {
    render(
      <BlastRadiusPanel counts={{ vehicles: 4, fuel_logs: 130 }} fleetName="Test" onPurge={vi.fn()} />,
    );
  ...
  it('renders an unknown count key rather than dropping it', () => {
    render(
      <BlastRadiusPanel counts={{ vehicles: 1, something_new: 9 }} fleetName="T" onPurge={vi.fn()} />,
    );
